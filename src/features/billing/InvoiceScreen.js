...
const InvoiceScreen = ({ navigation, route }) => {
  ...
  return (
    <ScreenTemplate
      showBackButton
      title={localInvoice.invoiceNo}
      subtitle="Invoice details and history"
      headerAction={<IconButton icon="download-outline" iconColor="#333" onPress={() => {}} />}
      headerContent={
      ...
      <View style={styles.metaGrid}>
        ...
        <View style={styles.metaItem}>
          ...
          <Text style={styles.metaValue}>
            {localInvoice.dueDate ? formatDate(localInvoice.dueDate) : 'N/A'}
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  badgeWrapper: { scaleX: 0.9, scaleY: 0.9, marginLeft: -5, marginTop: 10 },
  sectionLabel: {
    fontSize: 12,
    fontWeight: 'bold',
    color: '#BBB',
